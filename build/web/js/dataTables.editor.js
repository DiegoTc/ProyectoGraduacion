...
(function (m, o, n, e, j) {
    ...
    f.display.lightbox = k.extend(!0, {}, f.models.displayController, {
        ...
        _show: function (a) {
            ...
            k("div.DTED_Lightbox_Content_Wrapper",
                g._dom.wrapper).bind("click.DTED_Lightbox", function (a) {
    ...
    f.prototype.clear = function (a) {
        if (a)
            if (e.isArray(a))
                for (var c = 0, b = a.length; c < b; c++) this.clear(a[c]);
            ...
            else e("div." + this.classes.field.wrapper,
                this.dom.wrapper).remove(), this.s.fields.splice(0, this.s.fields.length), this.s.order.splice(0, this.s.order.length)
    };
    ...
    f.prototype.disable = function (a) {
        if (e.isArray(a))
            for (var c = 0, b = a.length; c < b; c++) this.disable(a[c]);
    ...
    f.prototype.enable = function (a) {
        if (e.isArray(a))
            for (var c = 0, b = a.length; c < b; c++) this.enable(a[c]);
    ...
    f.prototype.field = function (a) {
        var c = this,
            b = {}, d = this._findField(a),
            h = f.fieldTypes[d.type];
        e.each(h, function (a, e) {
            b[a] = "function" === typeof e ? function () {
    ...
    f.prototype._constructor = function (a) {
        ...
        var c = this,
            b = this.classes;
        this.dom = {
            wrapper: e('<div class="' + b.wrapper + '"><div data-dte-e="processing" class="' + b.processing.indicator + '"></div><div data-dte-e="head" class="' +
                ...
                b.footer.content + '"><div data-dte-e="form_error" class="' + b.form.error + '"></div><div data-dte-e="form_buttons" class="' + b.form.buttons + '"></div></div></div></div>')[0],
            form: null,
            formClear: null,
            formError: null,
            formInfo: null,
    ...
    f.prototype._callbackFire = function (a, c) {
        ...
        c === n && (c = []);
        if (e.isArray(a))
            for (b = 0; b < a.length; b++) this._callbackFire(a[b], c);
        else {
    ...
    f.prototype._findField = function (a) {
        for (var c = 0, b = this.s.fields.length; c < b; c++)
            if (this.s.fields[c].name === a) return this.s.fields[c];
        return n
    };
    f.prototype._findFieldIndex = function (a) {
        for (var c = 0, b = this.s.fields.length; c < b; c++)
            if (this.s.fields[c].name === a) return c;
        return n
    };
    f.prototype._message = function (a, c, b) {
        "" === b && this.s.displayed ? "slide" === c ? e(a).slideUp() : e(a).fadeOut() :
            "" === b ? a.style.display = "none" : this.s.displayed ? "slide" === c ? e(a).html(b).slideDown() : e(a).html(b).fadeIn() : (e(a).html(b), a.style.display = "block")
    };
    ...
    f.prototype._ajaxUri = function (a) {
        a = "create" ===
            this.s.action && this.s.ajaxUrl.create ? this.s.ajaxUrl.create : "edit" === this.s.action && this.s.ajaxUrl.edit ? this.s.ajaxUrl.edit.replace(/_id_/, this.s.id) : "remove" === this.s.action && this.s.ajaxUrl.remove ? this.s.ajaxUrl.remove.replace(/_id_/, a.join(",")) : this.s.ajaxUrl;
