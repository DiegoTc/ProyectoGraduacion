<%-- 
    Document   : dispositivoLuces
    Created on : 06-26-2013, 04:12:58 PM
    Author     : diego
--%>
    ...
    $(document).ready(function(){
        ...
        $( "#editar" ).button().click(function() {
            ...
            if(filas.length == 0){
                ...
                editarWatts.value=filas[0].watts
                $('#comboEditar').load('lista.jsp',{
                                                    id: '1',
...
<div id="contentwrapper">
    <div class="main_content"> 
        <h1 class="heading">Luces Electricas</h1>
        <div>
            <div class="btn-group">
    ...
    <div class="modal-body">
        <form>
            <fieldset>
                ...
                <label for="name">Watts</label>
                <input type="text" name="agregarWatts" id="agregarWatts"  />
            </fieldset>
        </form>
    </div>
    ...
    <div class="modal-body">
        <form>
            <fieldset>
                ...
                <label for="name">Watts</label>
                <input type="text" name="editarWatts" id="editarWatts"  />
            </fieldset>
        </form>
    </div>
