<%-- 
    Document   : login
    Created on : 06-01-2013, 08:28:00 AM
    Author     : diego
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import= "OwnClass.LoginCredential"%>
<!DOCTYPE html>
<html lang="en" class="login_page">
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <title>UNITEC DOMOTICA</title>
        ...
        if(iuser != "" && ipassword !="" ){
            String pass=LoginCredential.getInstancia().getEncryptedPassword(ipassword);
            if(LoginCredential.getInstancia().verifiedUser(iuser,ipassword)){
